    ...
    <div class="relative   min-h-screen  sm:flex sm:flex-row  justify-center bg-transparent rounded-3xl shadow-xl">
        <div class="flex-col flex  self-center lg:px-14 sm:max-w-4xl xl:max-w-md  z-10">
            <div class="self-start hidden lg:flex flex-col  text-gray-300">
                ...
                <p class="pr-3 text-sm opacity-75">Terus berbagi kebaikan Bersama kami </p>
            </div>
        </div>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="p-12 bg-gray-100 mx-auto rounded-3xl w-96 ">
                    <div class="mb-7">
                        ...
                        <p class="text-gray-400">Belum punya akun? <a href="{{route ('register')}}" class="text-sm text-blue-700 hover:text-blue-900">Daftar</a></p>
                    </div>
                    <div class="space-y-6">
                        <div class="">
                    ...
                    <div>
                        <button type="submit" class="w-full flex justify-center bg-blue-800  hover:bg-blue-700  text-gray-100 p-3  rounded-lg tracking-wide font-semibold  cursor-pointer transition ease-in duration-300 focus:outline-neutral-950 mt-10">
                            {{ __('Login') }}
                        </button>
